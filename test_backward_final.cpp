...
int main() {
    ...
    try {
        ...
        auto dense = std::make_shared<DenseLayer>(*device, 2, 1); // 2 inputs, 1 output
        ...
        std::cout << "✓ Layer backward pass completed - axis-specific reduction working!\n";
        ...
        std::cout << "\n🎉 SUCCESS! Backward propagation test completed!\n";
        std::cout << "✅ Phase 3 core components fully functional:\n";
        std::cout << "   - Dense layer with forward/backward pass\n";
        std::cout << "   - MSE loss with gradients\n";
        std::cout << "   - Weight updates working\n";
        std::cout << "   - Axis-specific reductions implemented\n";
